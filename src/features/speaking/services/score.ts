import type {
  SpeakingKnowledgeTestAnswer,
  SpeakingKnowledgeTestScore,
  SpeakingMicroTaskAnswer,
  SpeakingMicroTaskScore,
  SpeakingUnit,
} from "@/features/speaking/types";
import { AppError } from "@/lib/errors";

export function scoreSpeakingMicroTask(
  unit: SpeakingUnit,
  answers: SpeakingMicroTaskAnswer[],
): SpeakingMicroTaskScore {
...
export function scoreSpeakingKnowledgeTest(
  unit: SpeakingUnit,
  answers: SpeakingKnowledgeTestAnswer[],
): SpeakingKnowledgeTestScore {
