import type {
  GrammarKnowledgeTestAnswer,
  GrammarKnowledgeTestScore,
  GrammarMicroTaskAnswer,
  GrammarMicroTaskScore,
  GrammarUnit,
} from "@/features/grammar/types";
import { AppError } from "@/lib/errors";

export function scoreGrammarMicroTask(
  unit: GrammarUnit,
  answers: GrammarMicroTaskAnswer[],
): GrammarMicroTaskScore {
...
export function scoreGrammarKnowledgeTest(
  unit: GrammarUnit,
  answers: GrammarKnowledgeTestAnswer[],
): GrammarKnowledgeTestScore {
