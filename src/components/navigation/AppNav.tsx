        ...
        {links.map((link) => {
          ...
          return (
            <Link
              ...
              prefetch={false}
              scroll={false}
              className={`relative z-10 inline-flex min-h-11 shrink-0 touch-manipulation select-none items-center whitespace-nowrap rounded-full px-3 py-2 transition-colors ${
                active
